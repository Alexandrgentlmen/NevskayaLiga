...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_calendarDatePick__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/calendarDatePick */ "./src/js/components/calendarDatePick.js");
...
/* harmony import */ var _functions_disable_scroll__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./functions/disable-scroll */ "./src/js/functions/disable-scroll.js");
/* harmony import */ var _functions_enable_scroll__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./functions/enable-scroll */ "./src/js/functions/enable-scroll.js");
/* harmony import */ var graph_tabs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! graph-tabs */ "./node_modules/graph-tabs/src/graph-tabs.js");
/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! swiper */ "./node_modules/swiper/swiper.esm.js");
/* harmony import */ var _functions_makeBigSimbol_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./functions/makeBigSimbol.js */ "./src/js/functions/makeBigSimbol.js");
/* harmony import */ var _functions_makeBigSimbol_js__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_functions_makeBigSimbol_js__WEBPACK_IMPORTED_MODULE_9__);
...
new air_datepicker__WEBPACK_IMPORTED_MODULE_1__["default"]('#calendar', {
  inline: false,
  locale: air_datepicker_locale_ru__WEBPACK_IMPORTED_MODULE_2__["default"],
  startDate,
...
var image = document.getElementsByClassName('our-alboms__content');
new (simple_parallax_js__WEBPACK_IMPORTED_MODULE_3___default())(image, {
  customWrapper: '.our-alboms',
  delay: .95,
  orientation: 'down-up'
...
swiper__WEBPACK_IMPORTED_MODULE_8__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_8__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_8__.Pagination]);
const swiperHero = new swiper__WEBPACK_IMPORTED_MODULE_8__["default"]('.hero-swiper', {
  loop: true,
  spaceBetween: 2,
  navigation: {
...
/* harmony import */ var _vendor_search_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendor/search.js */ "./src/js/vendor/search.js");
/* harmony import */ var _vendor_search_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_vendor_search_js__WEBPACK_IMPORTED_MODULE_1__);



/***/ }),

/***/ "./src/js/components/calendarDatePick.js":
/*!***********************************************!*\
  !*** ./src/js/components/calendarDatePick.js ***!
  \***********************************************/
/***/ (() => {
...
(function () {
  const scrollBtn = document.querySelector('.scollToTop');
  window.onscroll = () => {
...
/***/ "./src/js/functions/makeBigSimbol.js":
/*!*******************************************!*\
  !*** ./src/js/functions/makeBigSimbol.js ***!
  \*******************************************/
/***/ (() => {
...
(function () {
  let elems = document.querySelectorAll('[data-bigNewsUppercase]');
  elems.forEach(elem => {
    let wordsArray = elem.textContent;
    const editedWords = wordsArray.replace(/(^|\s)\S/g, function (a) {
      return a.toUpperCase();
    });
    let h3 = document.createElement('h3');
    h3.className = 'big-news__newstitle';
    h3.innerHTML = editedWords;
    elem.replaceWith(h3);
  });
})();
(function () {
  let elems = document.querySelectorAll('[data-asideUppercase]');
  elems.forEach(elem => {
    let wordsArray = elem.textContent;
    const editedWords = wordsArray.replace(/(^|\s)\S/g, function (a) {
      return a.toUpperCase();
    ...
    let h3 = document.createElement('h3');
    h3.className = 'aside__newstitle';
    h3.innerHTML = editedWords;
    elem.replaceWith(h3);
  });
})();
(function () {
  let elems = document.querySelectorAll('[data-bigVideosUppercase]');
  elems.forEach(elem => {
    let wordsArray = elem.textContent;
    const editedWords = wordsArray.replace(/(^|\s)\S/g, function (a) {
      return a.toUpperCase();
    ...
    let h3 = document.createElement('h3');
    h3.className = 'featured-videos__newstitle';
    h3.innerHTML = editedWords;
    elem.replaceWith(h3);
  });
})();
(function () {
  let elems = document.querySelectorAll('[data-difvideosUppercase]');
  elems.forEach(elem => {
    let wordsArray = elem.textContent;
    const editedWords = wordsArray.replace(/(^|\s)\S/g, function (a) {
      return a.toUpperCase();
    ...
    let h3 = document.createElement('h3');
    h3.className = 'dif-videos__newstitle';
    h3.innerHTML = editedWords;
    elem.replaceWith(h3);
  });
})();
(function () {
  let elems = document.querySelectorAll('[data-fotoalbomsUppercase]');
  elems.forEach(elem => {
    let wordsArray = elem.textContent;
    const editedWords = wordsArray.replace(/(^|\s)\S/g, function (a) {
      return a.toUpperCase();
    ...
    let h3 = document.createElement('h3');
    h3.className = 'foto-alboms__newstitle';
    h3.innerHTML = editedWords;
    elem.replaceWith(h3);
  });
})();
...
const icon = document.querySelector('.info-block__search-loop');
const search = document.querySelector('.info-block__search-header');
const clear = document.querySelector('.info-block__clear');
